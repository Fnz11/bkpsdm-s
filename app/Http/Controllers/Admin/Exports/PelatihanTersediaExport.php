...
class PelatihanTersediaExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
        ...
        foreach ($this->columns as $column) {
            switch ($column) {
                ...
                case 'kuota':
                    ...
                    break;
                case 'biaya':
                    $row[] = 'Rp' . number_format($pelatihan->biaya, 0, ',', '.');
                    break;
                case 'status':
                    $row[] = ucfirst($pelatihan->status_pelatihan);
                    break;
                default:
                    $row[] = '';
                    break;
