...
<div class="modal fade" id="modalCetak" tabindex="-1" aria-labelledby="modalCetakLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <form action="{{ route('dashboard.pelatihan.alumni.cetak-pdf') }}" method="GET" target="_blank" id="form-cetak">
            @csrf
                    ...
                    <div id="step-filter" class="step-content active" data-step="1">
                        ...
                        <div class="mt-4">
                            ...
                            <div id="preview-empty" class="text-center py-4 bg-light rounded">
                                ...
                                <p class="mt-2 mb-0 text-muted" id="preview-empty-text">Gunakan filter untuk menampilkan
                                    data</p>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="modalExcel" tabindex="-1" aria-labelledby="modalExcelLabel" aria-hidden="true"
    style="z-index: 1501;">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <form action="{{ route('dashboard.pelatihan.alumni.cetak-excel') }}" method="GET" target="_blank"
            id="form-excel">
            @csrf
            <div class="modal-content border-0 shadow-lg">
                    ...
                    <div id="step-filter-excel" class="step-content active" data-step="1">
                        ...
                        <div class="mt-4">
                            ...
                            <div id="preview-empty-excel" class="text-center py-4 bg-light rounded">
                                <i class="bi bi-database-exclamation fs-3 text-muted"></i>
                                <p class="mt-2 mb-0 text-muted" id="preview-empty-text-excel">Gunakan filter untuk
                                    menampilkan data</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="laporan" id="col_laporan" checked>
                                                    <label class="form-check-label" for="col_laporan">Judul
                                                        Laporan</label>
                                                </div>
                                            </div>
                                        </div>
