...
@section('breadcrumb')
    <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active"><i class="bi bi-lightbulb"></i> Usulan Pelatihan</li>
    </ol>
@endsection
...
@section('content')
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu p-3 shadow" style="min-width: 600px;">
                            <div class="container-fluid">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="metode" id="filter-metode" class="form-select form-select-md">
                                            ...
                                            @foreach ($metodes as $metode)
                                                <option value="{{ $metode->id }}">{{ $metode->metode_pelatihan }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col-md-12">
                                        <label class="form-label small fw-semibold">Rentang Biaya</label>
                                        <div class="row g-2">
                                            <div class="col-md-6">
                                                <input type="number" id="filter-min-cost"
                                                    class="form-control form-control-md" placeholder="Biaya Minimum"
                                                    min="0" step="1000">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="number" id="filter-max-cost"
                                                    class="form-control form-control-md" placeholder="Biaya Maksimum"
                                                    min="0" step="1000">
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    @include('dashboard.pelatihan.usulan._table', ['pelatihan' => $pelatihans])
                </table>
            </div>
    ...
    @include('dashboard.pelatihan.usulan.modal-cetak')
@endsection
...
@section('scripts')
    ...
    @endif
    @include('dashboard.pelatihan.usulan.script')
@endsection
