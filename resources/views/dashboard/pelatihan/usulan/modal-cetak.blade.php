...
<div class="modal fade" id="modalCetak" tabindex="-1" aria-labelledby="modalCetakLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <form action="{{ route('dashboard.pelatihan.usulan.cetak-pdf') }}" method="GET" target="_blank"
            id="form-cetak">
            @csrf
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title fw-semibold">Cetak PDF Pelatihan Usulan</h5>
                ...
                <div class="modal-body p-4">
                    ...
                    <div id="step-filter" class="step-content active" data-step="1">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="filter-modal-search" class="form-control"
                                        placeholder="Cari nama pelatihan/penyelenggara...">
                                </div>
                            </div>
                        </div>
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="metode" id="filter-modal-metode" class="form-select">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="pelaksanaan" id="filter-modal-pelaksanaan" class="form-select">
                                    <option value="">Semua</option>
                                    @foreach ($pelaksanaans as $pelaksanaan)
                                        <option value="{{ $pelaksanaan->id }}">{{ $pelaksanaan->pelaksanaan_pelatihan }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label fw-semibold">Rentang Tanggal Pelatihan</label>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    <td>Metode</td>
                                                    <td>: <span id="summary-metode">Semua</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Pelaksanaan</td>
                                                    <td>: <span id="summary-pelaksanaan">Semua</span></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    <td>Margin</td>
                                                    <td>: <span id="summary-margins">0.5in (atas), 0.5in (kanan), 0.5in
                                                            (bawah), 0.5in (kiri)</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Header</td>
                                                    <td>: <span id="summary-header">Aktif</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Footer</td>
                                                    <td>: <span id="summary-footer">Aktif</span></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                    ...
                    <input type="hidden" name="pelaksanaan" id="input-pelaksanaan">
...
<div class="modal fade" id="modalExcel" tabindex="-1" aria-labelledby="modalExcelLabel" aria-hidden="true"
    style="z-index: 1501;">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <form action="{{ route('dashboard.pelatihan.usulan.cetak-excel') }}" method="GET" target="_blank"
            id="form-excel">
            @csrf
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title fw-semibold">Export Excel Pelatihan Usulan</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div id="step-filter-excel" class="step-content active" data-step="1">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Metode</label>
                                <select name="metode" id="filter-modal-metode-excel" class="form-select">
                                    <option value="">Semua</option>
                                    @foreach ($metodes as $metode)
                                        <option value="{{ $metode->id }}">{{ $metode->metode_pelatihan }}</option>
                                    @endforeach
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Pelaksanaan</label>
                                <select name="pelaksanaan" id="filter-modal-pelaksanaan-excel" class="form-select">
                                    <option value="">Semua</option>
                                    @foreach ($pelaksanaans as $pelaksanaan)
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="pengusul" id="col_pengusul" checked>
                                                    <label class="form-check-label" for="col_pengusul">Nama
                                                        Pengusul</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="col_nama">Nama
                                                        Pelatihan</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="col_jenis">Jenis</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="metode" id="col_metode" checked>
                                                    <label class="form-check-label" for="col_metode">Metode</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="pelaksanaan" id="col_pelaksanaan" checked>
                                                    <label class="form-check-label"
                                                        for="col_pelaksanaan">Pelaksanaan</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="penyelenggara" id="col_penyelenggara" checked>
                                                    <label class="form-check-label"
                                                        for="col_penyelenggara">Penyelenggara</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="tempat" id="tempat" checked>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="tanggal" id="col_tanggal" checked>
                                                    <label class="form-check-label" for="col_tanggal">Tanggal</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="kuota" id="col_kuota" checked>
                                                    <label class="form-check-label" for="col_kuota">Kuota</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="estimasi" id="col_estimasi" checked>
                                                    <label class="form-check-label" for="col_estimasi">Estimasi Biaya</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="columns[]"
                                                        value="realisasi" id="col_realisasi" checked>
                                                    <label class="form-check-label" for="col_realisasi">Realisasi Biaya</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    <td>Metode</td>
                                                    <td>: <span id="summary-metode-excel">Semua</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Pelaksanaan</td>
                                                    <td>: <span id="summary-pelaksanaan-excel">Semua</span></td>
                                                </tr>
                                                <tr>
                                                    <td>Rentang Tanggal</td>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    <td>Kolom Dipilih</td>
                                                    <td>: <span id="summary-columns">9 kolom</span></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                    ...
                    <input type="hidden" name="metode" id="input-metode-excel">
                    <input type="hidden" name="pelaksanaan" id="input-pelaksanaan-excel">
