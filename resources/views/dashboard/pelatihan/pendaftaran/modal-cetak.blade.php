        ...
        <form action="{{ route('dashboard.pelatihan.pendaftaran.cetak-pdf') }}" method="GET" target="_blank"
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-4">
                    <!-- Progress Bar -->
                    <div class="d-flex justify-content-between align-items-center position-relative mb-4 step-progress-pdf">
                        <!-- STEP 1 -->
...
<style>
    ...
    .step-progress-pdf[data-step="4"] .progress-line::before {
        width: 100%;
    }
