...
@section('page-title', 'Pendaftaran Pelatihan')

@section('breadcrumb')
    <ol class="breadcrumb mt-2">
        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
        <li class="breadcrumb-item active">Pendaftaran Pelatihan</li>
    </ol>
@endsection
...
@section('content')
    <div class="card border-0 shadow-sm p-3">
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="status-verif" id="filter-status-verif"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="status-peserta" id="filter-status-peserta"
                                            class="form-select form-select-md">
                                            <option value="">Semua</option>
                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center gap-2">
                    <button type="button" class="btn btn-outline-primary border border-primary" data-bs-toggle="modal"
                        data-bs-target="#modalUpdateBulk">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                @include('dashboard.pelatihan.pendaftaran._table', ['pendaftarans' => $pendaftarans])
            </div>
        </div>
    ...
    @include('dashboard.pelatihan.pendaftaran.modal-cetak')
    @include('dashboard.pelatihan.pendaftaran.modal-update')
@endsection
...
@section('scripts')
    ...
    @endif
    @include('dashboard.pelatihan.pendaftaran.script')
    @include('dashboard.pelatihan.pendaftaran.script-update')
@endsection
