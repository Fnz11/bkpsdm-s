<table class="table table-hover align-middle mb-0">
    ...
    <tbody id="pelatihan-table">
        @forelse($rekapPelatihan as $item)
            <tr class="border-bottom">
                <td class="text-center col-no">
                    {{ ($rekapPelatihan->currentPage() - 1) * $rekapPelatihan->perPage() + $loop->iteration }}
                </td>
        ...
        @empty
            <tr>
                <td colspan="4" class="text-center py-4">Tidak ada data pelatihan.</td>
            </tr>
        @endforelse
    </tbody>
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="3">
                <div id="pagination-wrapper-pelatihan" class="px-5 py-3">
                    {{ $rekapPelatihan->links('pagination::bootstrap-5') }}
                </div>
            </td>
        </tr>
    </tfoot>
